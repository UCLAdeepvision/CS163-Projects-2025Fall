...
Build upon the structural precision achieved by our Boundary-Aware (BA) approach, we further introduce **a Copy-Paste Augmentation** strategy that fundamentally alters the training data distribution. While the BA method refines *how* the model learns, this augmentation strategy refines *what* the model sees during training.
