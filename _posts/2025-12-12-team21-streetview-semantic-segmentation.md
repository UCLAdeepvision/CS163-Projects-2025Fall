...
_Fig 2. Figure depicting bounding boxes generated by Grounded SAM_ [1].
...
<p><em>Fig 3. Car model from different angles</em>.</p>
...
[1] L. B. Eyer. "pydensecrf: Python wrapper for DenseCRF." GitHub repository. 2015. [Online]. Available: https://github.com/lucasb-eyer/pydensecrf

[2] Hugging Face. "Grounding DINO." Hugging Face Transformers Documentation. 2023. [Online]. Available: https://huggingface.co/docs/transformers/en/model_doc/grounding-dino
