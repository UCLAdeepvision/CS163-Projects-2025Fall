...
author: Max Fukuhara, Nathan Chan, Jason Tran, Michael Co
date: 2025-12-13
---
...
- [2. Dataset](#2-dataset)
    - [2.1. FER-2013](#21-fer-2013)
    - [2.2. FER+ (2016)](#22-fer-2016)
- [3. ResFace](#3-resface)
    - [3.1. Overview](#31-overview)
    - [3.2. Local Feature Extraction](#32-local-feature-extraction)
    - [3.3. Channel-Spatial Feature Aggregation Module](#33-channel-spatial-feature-aggregation-module)
    - [3.4. Compact Feature Aggregation Module & Label Distribution Learning (LDL)](#34-compact-feature-aggregation-module-label-distribution-learning-ldl)
    - [3.5. Train, Validation, Test Set-Up](#35-train-validation-test-set-up)
    - [3.6. Results](#36-results)
    - [3.7. Tradeoffs](#37-tradeoffs)
- [4. EmoNeXt](#4-emonext)
    - [4.1. Overview](#41-overview)
    - [4.2. Spatial Transformer Network](#42-spatial-transformer-network)
    - [4.3. ConvNeXt](#43-convnext)
    - [4.4. Squeeze and Excitation Blocks](#44-squeeze-and-excitation-blocks)
    - [4.5. Training](#45-training)
    - [4.7. Code Implementation](#47-code-implementation)
    - [4.8. Results](#48-results)
    - [4.9. Pros and Cons](#49-pros-and-cons)
...
<br>
![]({{ '/assets/images/03/title.png' | relative_url }})
...
<br>
![]({{ '/assets/images/03/fer.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
<br>
...
<br>
![]({{ '/assets/images/03/fer_plus_examples.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
<br>
![]({{ '/assets/images/03/fer_plus.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
<br>
...
<br>
![]({{ '/assets/images/03/resface.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
<br>
![]({{ '/assets/images/03/resface-feature-extraction.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
<br>
![]({{ '/assets/images/03/resface-1.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
<br>
![]({{ '/assets/images/03/resface-feature-aggregation.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
<br>
![]({{ '/assets/images/03/resface-2.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
<br>
![]({{ '/assets/images/03/resface-table2.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
[7]
<br>
...
<br>
![]({{ '/assets/images/03/resface-table4.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
[7]
<br>
...
<br>
![]({{ '/assets/images/03/resface-table5.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
[7]
<br>

<br>
![]({{ '/assets/images/03/resface-table6.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
[7]
<br>
...
<br>
![]({{ '/assets/images/03/emonext.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
<br>
![]({{ '/assets/images/03/spatial-transformer.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
<br>
![]({{ '/assets/images/03/convnext-block.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
*ConvNeXt block* [2].
<br>
...
<br>
![]({{ '/assets/images/03/squeeze-and-excite.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
...
![]({{ '/assets/images/03/emonext-results.png' | relative_url }})
{: style="width: 800px; max-width: 100%;"}
[2]
